...
const CodeAuth = () => {
  ...
  return (
    <View style={styles.container}>
      <Text onPress={() => navigation.navigate("phonevalidation")} style={{width: "fit-content"}}>
      ...
      <Text style={styles.h1}>Entrer le code d’authentification</Text>
      <Text style={{ marginBottom: "40px", lineHeight: "25px" }}>Entrez les 7 chiffres reçus par sms au +224 629 00 00 00</Text>
      <InputText
        placeholder={"Enter les 7 chiffres reçu par sms"}
        icon1={
      ...
      <View style={{marginTop: "40px"}}>
        <DefaultButton
          title={"Continuer"}
          onPress={() => navigation.navigate("nationalitychoice")}
        />
      </View>
